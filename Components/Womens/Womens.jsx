...
import { selectWomensProducts } from '../../store/womensSlice';
import { ShoppingCartIcon, EyeIcon, ChevronLeftIcon, ChevronRightIcon } from '@heroicons/react/24/solid';
import { useState } from 'react';

export default function Womens() {
    const products = useSelector(selectWomensProducts); // استخدام Redux لاستخراج المنتجات النسائية
    ...
    return (
        <div className="flex flex-col items-center px-4 md:px-8 pt-8">
            <h1 className="text-3xl font-bold mb-2 text-left w-full max-w-6xl">Womens Latest</h1>
            <p className="text-lg text-gray-700 mb-4 w-full max-w-6xl text-left">
                Discover the latest trends in women's fashion. Shop our newest arrivals and find the perfect outfit!
            </p>
